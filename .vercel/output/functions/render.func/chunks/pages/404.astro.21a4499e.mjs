import { c as createAstro, a as createComponent, r as renderTemplate, b as addAttribute, m as maybeRenderHead, s as spreadAttributes, u as unescapeHTML, d as renderComponent, e as renderHead, f as renderSlot } from '../astro.f25fdf20.mjs';
...
const $$MainHead = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const {
    title = "Home: David Arthur [Assan]",
    description = "The personal site of David Arthur"
  } = Astro2.props;
...
}, "/Users/darth/Desktop/portfolio-website/src/components/MainHead.astro", void 0);
...
const iconPaths = {
  ...
  "linkedin-logo": `<rect width="256" height="256" fill="none"></rect><rect x="36" y="36" width="184" height="184" rx="8" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></rect><line x1="120" y1="112" x2="120" y2="176" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line><line x1="88" y1="112" x2="88" y2="176" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line><path d="M120,140a28,28,0,0,1,56,0v36" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path><circle cx="88" cy="80" r="12"></circle>`
};
...
const $$Icon = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 256 256" aria-hidden="true"${addAttribute(gradient ? `url(#${gradientId})` : color, "stroke")}${spreadAttributes(attrs, "attrs", { "class": "astro-PATNJMLL" })}>
...
}, "/Users/darth/Desktop/portfolio-website/src/components/Icon.astro", void 0);
...
` })}`;
}, "/Users/darth/Desktop/portfolio-website/src/components/ThemeToggle.astro", void 0);
...
const $$Nav = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const textLinks = [
    ...
    { label: "Blog", href: "https://blog.assan.xyz" }
  ];
  const iconLinks = [
    {
      label: "Twitter",
    ...
    {
      label: "GitHub",
      href: "https://github.com/darth-assan",
      icon: "github-logo"
    }
  ];
...
}, "/Users/darth/Desktop/portfolio-website/src/components/Nav.astro", void 0);
...
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <div class="group astro-SZ7XMLTE">
    <p class="astro-SZ7XMLTE">&copy; ${currentYear} David Arthur [Assan]</p>
  </div>
...
}, "/Users/darth/Desktop/portfolio-website/src/components/Footer.astro", void 0);
...
}, "/Users/darth/Desktop/portfolio-website/src/layouts/BaseLayout.astro", void 0);
...
}, "/Users/darth/Desktop/portfolio-website/src/components/Hero.astro", void 0);
...
}, "/Users/darth/Desktop/portfolio-website/src/components/Pill.astro", void 0);
...
const $$404 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${renderComponent($$result2, "Hero", $$Hero, { "title": "Page Not Found", "tagline": "Let's go home", "class": "astro-ZETDM5MD" })}
  ${maybeRenderHead()}<a href="/" class="roles astro-ZETDM5MD">
    ${renderComponent($$result2, "Pill", $$Pill, { "class": "astro-ZETDM5MD" }, { "default": ($$result3) => renderTemplate`${renderComponent($$result3, "Icon", $$Icon, { "icon": "arrow-left", "size": "1.33em", "class": "astro-ZETDM5MD" })}Home` })}
  </a>
` })}`;
}, "/Users/darth/Desktop/portfolio-website/src/pages/404.astro", void 0);

const $$file = "/Users/darth/Desktop/portfolio-website/src/pages/404.astro";
const $$url = "/404";
...
export { $$Icon as $, _404 as _, $$BaseLayout as a, $$Hero as b, $$Pill as c };
